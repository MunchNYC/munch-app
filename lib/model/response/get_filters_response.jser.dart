...
abstract class _$GetFiltersResponseJsonSerializer
  ...
  Map<String, dynamic> toMap(GetFiltersResponse model) {
    ...
    setMapValue(
        ret,
        'allFilters',
        codeIterable(model.allFilters,
            (val) => _filterJsonSerializer.toMap(val as Filter)));
    setMapValue(
        ret,
        'topFilters',
        codeIterable(model.topFilters,
            (val) => _filterJsonSerializer.toMap(val as Filter)));
    return ret;
  }
  ...
  GetFiltersResponse fromMap(Map map) {
    ...
    obj.allFilters = codeIterable<Filter>(map['allFilters'] as Iterable,
        (val) => _filterJsonSerializer.fromMap(val as Map));
    obj.topFilters = codeIterable<Filter>(map['topFilters'] as Iterable,
        (val) => _filterJsonSerializer.fromMap(val as Map));
    return obj;
  }
}
