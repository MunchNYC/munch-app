...
class TutorialRestaurantSwipeScreen extends StatefulWidget {
  ...
  TutorialRestaurantSwipeScreen(
      {this.munch, this.restaurant, this.tutorialState});
...
class _TutorialRestaurantSwipeScreenState
    extends State<TutorialRestaurantSwipeScreen> {
  void _onScreenTapped() async {
    setState(() {
      widget.tutorialState =
          TutorialState.values[widget.tutorialState.index + 1];
    });

    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    sharedPreferences.setInt(
        StorageKeys.SWIPE_TUTORIAL_STATE, widget.tutorialState.index);
    ...
    return SafeArea(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            Expanded(
                child: Material(
                    elevation: widget.munch.munchStatus == MunchStatus.UNDECIDED
                        ? 0.0
                        : 4.0,
                    ...
                    child: Container(
                      ...
                      child: Center(
                          child: widget.munch.munchStatus ==
                                  MunchStatus.UNDECIDED
                              ? Text(
                                  App.translate(
