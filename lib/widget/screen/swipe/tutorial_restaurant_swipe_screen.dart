    ...
    return GestureDetector(
        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                padding:
                    AppDimensions.padding(AppPaddingType.screenWithAppBar).copyWith(top: 8.0, left: 0.0, right: 0.0),
                child: _renderScreen(context))));
  }

  Widget _renderScreen(BuildContext context) {
    return Column(children: [
      Expanded(child: Container(child: _draggableCard(), padding: EdgeInsets.symmetric(horizontal: 8.0))),
      SizedBox(height: 8.0),
      InvisibleWidget(child: Divider(height: 1.0, thickness: 2.0, color: Palette.secondaryLight.withOpacity(0.7))),
      Padding(padding: EdgeInsets.fromLTRB(24.0, 8.0, 24.0, 16.0), child: InvisibleWidget(child: _decisionInfoBar()))
    ]);
  }
        ...
        if (widget.tutorialState == TutorialState.TUTORIAL_SWIPE)
          Container(
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(16.0), border: Border.all(color: Palette.background, width: 2.0)))
      ]),
    );
  }
            ...
            Expanded(
                child: Material(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          color: widget.munch.munchStatus == MunchStatus.UNDECIDED
                              ? Palette.background
