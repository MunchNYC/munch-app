...
class _DecisionScreenState extends State<DecisionScreen> {
        ...
        child: Stack(
          children: <Widget>[
            ...
            Positioned(
              ...
              bottom: 4.0,
              child: Text(
                (_currentCarouselPage + 1).toString() + "/" + widget.restaurant.photoUrls.length.toString(),
    ...
    return InkWell(
        ...
        child: Container(
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(color: Palette.primary.withOpacity(0.5), spreadRadius: 2, blurRadius: 3),
              ],
            ),
  ...
  Widget _moreIcon() {
    return InkWell(
        onTap: () {
          NavigationHelper.navigateToMunchOptionsScreen(context, munch: widget.munch).then((value) {
            _checkNavigationToSwipeScreen();
    ...
    return Row(mainAxisSize: MainAxisSize.max, children: [
      ...
      Expanded(
        child: Column(
          ...
          children: [
            Text(
                App.translate("decision_screen.munch_unmodifiable.description") +
                    " " +
            ...
            CustomButton(
              ...
              onPressedCallback: () {
                ...
                OverlayDialogHelper(widget: ReviewMunchDialog(munchBloc: _munchBloc, munch: widget.munch))
                    .show(context);
              },
            )
          ],
  ...
  Widget _restaurantDetails() {
    return Column(
      ...
      children: <Widget>[
        ...
        _linkIconsRow(),
        SizedBox(height: 8.0),
        if (widget.restaurant.workingHours != null && widget.restaurant.workingHours.length > 0) _workingHours(),
      ],
    );
  }
      ...
      children: <Widget>[
        Text(App.translate("decision_screen.restaurant.hours.subtitle"),
            style: AppTextStyle.style(AppTextStylePattern.body2,
                color: Palette.primary.withOpacity(0.7), fontWeight: FontWeight.w600)),
        SizedBox(height: 8.0),
    ...
    return GestureDetector(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            _starsRating(),
            SizedBox(width: 8.0),
            Text(widget.restaurant.reviewsNumber.toString() + " " + App.translate('decision_screen.yelp.reviews.text'),
    ...
    return Row(
      children: <Widget>[
        Expanded(
          ...
          content: Text(App.translate("decision_screen.continue_exploring_button.text"),
              style: AppTextStyle.style(AppTextStylePattern.body2SecondaryDark)),
        ...
        Expanded(
          ...
          textColor: Palette.secondaryDark,
          padding: EdgeInsets.symmetric(vertical: 12.0),
          content: Text(App.translate("decision_screen.new_restaurant_button.text"),
              style: AppTextStyle.style(AppTextStylePattern.body2SecondaryDark)),
          onPressedCallback: () {
            OverlayDialogHelper(widget: NewRestaurantAlertDialog(munchId: widget.munch.id, munchBloc: _munchBloc))
                .show(context);
          },
        )),
      ],
