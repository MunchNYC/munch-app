            ...
            child: Column(
              ...
              children: <Widget>[
                Stack(children: [
                  Center(
                      child: Text(
                          App.translate("new_restaurant_alert_dialog.title"),
                  ...
                  Align(
                      ...
                      child: CustomButton(
                        ...
                        content: Text(
                            App.translate(
                                "new_restaurant_alert_dialog.cancel_action.text"),
                ...
                SafeArea(
                    ...
                    child: CustomButton(
                      ...
                      content: Text(
                          App.translate(
                              "new_restaurant_alert_dialog.new_restaurant_button.text"),
                          style: AppTextStyle.style(
                              AppTextStylePattern.body2SecondaryDark,
                              fontSizeOffset: 1.0)),
                      onPressedCallback: () {
                        munchBloc
                            .add(NewMunchRestaurantEvent(munchId: munchId));
                        // close dialog
                        NavigationHelper.popRoute(context);
                      },
                    ))
