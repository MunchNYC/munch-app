...
class _LoginScreenState extends State<LoginScreen> {
          ...
          Expanded(
            child: Container(
                ...
                child: Column(
                    ...
                    children: <Widget>[Expanded(child: _appBrandArea()), Expanded(child: _loginButtons())])),
          ),
          _footerText()
        ]));
  }
  ...
  Widget _appBrandArea() {
    return Column(mainAxisSize: MainAxisSize.max, mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
      Text(App.translate("login_screen.title"),
          style: AppTextStyle.style(AppTextStylePattern.heading1SecondaryDark,
              fontSizeOffset: 32.0, fontWeight: FontWeight.w600)),
        ...
        child: RichText(
            ...
            text: TextSpan(
                ...
                children: [
                  ...
                  TextSpan(text: " " + App.translate("login_screen.footer.conjunction") + " "),
                  TextSpan(
