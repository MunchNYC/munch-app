...
class MunchCodeDialog extends StatelessWidget{
  ...
  Widget _titleText(){
    return Text(App.translate("munch_code_dialog.title"),
        style: AppTextStyle.style(AppTextStylePattern.heading6, fontWeight: FontWeight.w500), textAlign: TextAlign.center
    );
  }
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          _copyButton(context),
          SizedBox(width: 8.0),
          Text(munch.link, style: AppTextStyle.style(AppTextStylePattern.body3), textAlign: TextAlign.center),
          SizedBox(width: 8.0),
          _shareButton()
        ],
      )
