    ...
    return Padding(
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                Padding(
                    ...
                    child: Row(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Text(App.translate("empty_munches_list_widget.tutorial.description_row_1.text") + " ",
                            style: AppTextStyle.style(AppTextStylePattern.heading6,
                                fontWeight: FontWeight.w400, color: Palette.primary)),
                        Icon(
                          Icons.add,
                          size: AppDimensions.scaleSizeToScreen(16.0),
                          color: Palette.secondaryDark,
                        ),
                        Text(" " + App.translate("empty_munches_list_widget.tutorial.description_row_2.text"),
                            style: AppTextStyle.style(AppTextStylePattern.heading6,
                                fontWeight: FontWeight.w400, color: Palette.primary)),
                      ],
                    )),
                    ...
                    child: Padding(
                      ...
                      child: Transform(
                          ...
                          child: Transform.rotate(
                              angle: -pi / 2,
                              child: ImageIcon(AssetImage("assets/icons/curvedArrow.png"),
                                  size: 30.0, color: Palette.secondaryDark))),
                    ))
              ],
            ),
                ...
                text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                        ...
                        style:
                            AppTextStyle.style(AppTextStylePattern.heading6SecondaryDark, fontWeight: FontWeight.w500),
                      ),
                      TextSpan(
            ...
            Text("- " + App.translate("empty_munches_list_widget.tutorial.join_create_row_separator.text") + " -",
                style: AppTextStyle.style(AppTextStylePattern.heading6, fontWeight: FontWeight.w400)),
            SizedBox(height: 16.0),
            RichText(
                textAlign: TextAlign.center,
              ...
              child: Container(
                  ...
                  child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          CustomButton(
                              content: Text(App.translate("empty_munches_list_widget.start_button.text"),
                              ...
                              onPressedCallback: () {
                                DialogHelper(dialogContent: CreateJoinDialog(munchBloc: munchBloc), rootNavigator: true)
                                    .show(context);
                              }),
                        ],
                      ))),
