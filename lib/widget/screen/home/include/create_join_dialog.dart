...
class CreateJoinDialog extends StatefulWidget {
  ...
  CreateJoinDialog(
      {this.munchBloc, this.addCurrentScreenToBackStackOnCreate = true});
...
class CreateJoinDialogState extends State<CreateJoinDialog> {
  ...
  CreateJoinDialogState() {
    for (int i = 0; i < TOTAL_MUNCH_NAME_PLACEHOLDERS; i++) {
      _munchNamePlaceholders.add(App.translate(
          "create_join_dialog_create_form.name_field.placeholder${i + 1}.value"));
    }

    _munchNamePlaceholder =
        _munchNamePlaceholders[Random().nextInt(TOTAL_MUNCH_NAME_PLACEHOLDERS)];
  }

  final TextEditingController _joinTextEditingController =
                    ...
                    children: <Widget>[
                      Text(App.translate("create_join_dialog.join_form.title"),
                          style: AppTextStyle.style(AppTextStylePattern.body2,
                              fontSizeOffset: 2.0, color: Palette.primary)),
                      ...
                      SizedBox(height: 12.0),
                      Text(
                          App.translate("create_join_dialog.create_form.title"),
                          style: AppTextStyle.style(AppTextStylePattern.body2,
                              fontSizeOffset: 2.0, color: Palette.primary)),
                      SizedBox(height: 12.0),
  ...
  String _validateJoinForm(String value) {
    ...
    if (!regex.hasMatch(value)) {
      return App.translate(
          "create_join_dialog.join_form.code_field.regex.validation");
    } else {
      return null;
    }
  }
  ...
  String _validateCreateForm(String value) {
    ...
    if (!regex.hasMatch(value)) {
      return App.translate(
          "create_join_dialog.create_form.name_field.regex.validation");
    } else {
      return null;
    }
  }
      ...
      child: Row(
        ...
        children: <Widget>[
          Expanded(
            ...
            hintText:
                App.translate("create_join_dialog.join_form.code_field.hint"),
            ...
            onChanged: (value) {
              WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
                _joinTextEditingController.value = _joinTextEditingController
                    .value
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          CustomButton(
              ...
              textColor: Palette.background,
              content: Text(
                  App.translate("create_join_dialog.create_button.text"),
                  style: AppTextStyle.style(AppTextStylePattern.body3Inverse)),
              onPressedCallback: () {
