...
class ReviewMunchDialog extends StatelessWidget {
                      ...
                      children: [
                        Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(color: Palette.primary.withOpacity(0.3), spreadRadius: 2, blurRadius: 3),
                              ],
                            ),
                            child: Column(
                                mainAxisSize: MainAxisSize.min,
  ...
  Widget _likeButton(MunchState state) {
    return CustomButton(
      ...
      content: Text(App.translate("review_munch_dialog.liked_button.text"),
          style: AppTextStyle.style(AppTextStylePattern.heading5, fontWeight: FontWeight.w500)),
      onPressedCallback: () {
        munchBloc.add(
            ReviewMunchEvent(munchReviewValue: MunchReviewValue.LIKED, munchId: munch.id, forcedReview: forcedReview));
      },
    );
  }
  ...
  Widget _neutralButton(MunchState state) {
    return CustomButton(
      ...
      textColor: Palette.primary,
      minWidth: App.REF_DEVICE_WIDTH,
      content: Text(App.translate("review_munch_dialog.neutral_button.text"),
          style: AppTextStyle.style(AppTextStylePattern.heading5, fontWeight: FontWeight.w500)),
      onPressedCallback: () {
        munchBloc.add(ReviewMunchEvent(
            munchReviewValue: MunchReviewValue.NEUTRAL, munchId: munch.id, forcedReview: forcedReview));
      },
    );
  }
  ...
  Widget _dislikeButton(MunchState state) {
    return CustomButton(
      ...
      textColor: Palette.primary,
      minWidth: App.REF_DEVICE_WIDTH,
      content: Text(App.translate("review_munch_dialog.disliked_button.text"),
          style: AppTextStyle.style(AppTextStylePattern.heading5, fontWeight: FontWeight.w500)),
      onPressedCallback: () {
        munchBloc.add(ReviewMunchEvent(
            munchReviewValue: MunchReviewValue.DISLIKED, munchId: munch.id, forcedReview: forcedReview));
      },
    );
  }
  ...
  Widget _didNotGoLabel(MunchState state) {
    return CustomButton(
      ...
      flat: true,
      content: Text(App.translate("review_munch_dialog.did_not_go_label.text"),
          style: AppTextStyle.style(AppTextStylePattern.heading6SecondaryDark, fontWeight: FontWeight.w500),
          textAlign: TextAlign.center),
      onPressedCallback: () {
        munchBloc.add(
            ReviewMunchEvent(munchReviewValue: MunchReviewValue.NOSHOW, munchId: munch.id, forcedReview: forcedReview));
      },
    );
  }
  ...
  Widget _skipLabel(MunchState state, BuildContext context) {
    return CustomButton(
      ...
      flat: true,
      content: Text(App.translate("review_munch_dialog.skip_label.text"),
          style: AppTextStyle.style(AppTextStylePattern.body2, fontSizeOffset: 2.0, color: Palette.secondaryLight),
          textAlign: TextAlign.center),
      onPressedCallback: () {
        if (forcedReview) {
          munchBloc.add(ReviewMunchEvent(
              munchReviewValue: MunchReviewValue.SKIPPED, munchId: munch.id, forcedReview: forcedReview));
        } else {
