...
class _ProfileTabScreenState extends State<ProfileTab> {
          ...
          Flexible(
            ...
            children: [
              Text(_user.displayName,
                  style: AppTextStyle.style(AppTextStylePattern.heading3, fontWeight: FontWeight.w400),
                  maxLines: 2,
                  overflow: TextOverflow.fade),
              SizedBox(height: 4.0),
              Text(_user.email,
                  style:
                      AppTextStyle.style(AppTextStylePattern.body3, fontSizeOffset: 1.0, fontWeight: FontWeight.w400),
                  maxLines: 2,
                  overflow: TextOverflow.fade)
            ],
          ))
  ...
  Widget _menuItems() {
    return Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
      AccountTabMenuItem(
          text: App.translate("account_tab.menu_item.personal_information.text"),
          onTap: _onPersonalInformationTapped,
          trailingIcon: ImageIcon(AssetImage("assets/icons/personalInformation.png"),
      ...
      AccountTabMenuItem(
          ...
          trailingIcon:
              ImageIcon(AssetImage("assets/icons/notification.png"), size: AppDimensions.scaleSizeToScreen(28.0))),
      _menuListItemDivider(),
      AccountTabMenuItem(
          text: App.translate("account_tab.menu_item.invite_friends.text"),
          onTap: _onInviteFriendsItemClicked,
          trailingIcon:
              ImageIcon(AssetImage("assets/icons/inviteFriends.png"), size: AppDimensions.scaleSizeToScreen(28.0))),
      _menuListItemDivider(),
      AccountTabMenuItem(
          text: App.translate("account_tab.menu_item.feedback.text"),
          onTap: _onFeedbackItemClicked,
          trailingIcon:
              ImageIcon(AssetImage("assets/icons/giveUsFeedback.png"), size: AppDimensions.scaleSizeToScreen(28.0))),
      _menuListItemDivider(),
      AccountTabMenuItem(
      ...
      AccountTabMenuItem(
          ...
          trailingIcon: ImageIcon(AssetImage("assets/icons/termsAndConditions.png"),
              size: AppDimensions.scaleSizeToScreen(28.0))),
      _menuListItemDivider(),
      AccountTabMenuItem(
