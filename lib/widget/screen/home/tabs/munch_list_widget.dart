...
class MunchListWidget extends StatelessWidget {
        ...
        if (munch.munchStatusChanged &&
          ...
          Positioned(
            ...
            child: Icon(Icons.circle,
                ...
                size: AppDimensions.scaleSizeToScreen(12.0)),
          )
      ],
    );
  }
    ...
    return Column(
        ...
        children: <Widget>[
          ...
          if (munch.munchStatus != MunchStatus.UNDECIDED)
            _decidedUnmodifiableHistoricalThirdRow(),
        ]);
  }
  ...
  String _formatCreationTimestamp(DateTime creationTimestamp) {
    ...
    if (calendarTime.isToday) {
      formattedTimestamp =
          App.translate("munch_list_widget.creation_timestamp.today.text");
    } else if (calendarTime.isYesterday) {
      formattedTimestamp =
          App.translate("munch_list_widget.creation_timestamp.yesterday.text");
    } else if (calendarTime.isTomorrow) {
      formattedTimestamp =
          App.translate("munch_list_widget.creation_timestamp.tomorrow.text");
    } else {
        ...
        Row(
          ...
          children: <Widget>[
            ...
            Icon(Icons.navigate_next,
                color: Palette.secondaryLight.withOpacity(0.6), size: 16.0)
          ],
        ),
      ],
    );
  ...
  Widget _secondRow() {
    return Text(
        munch.getNumberOfMembers().toString() +
            " " +
            App.translate("munch_list_widget.members.text"),
        style: AppTextStyle.style(AppTextStylePattern.body2,
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(App.translate("munch_list_widget.swipe_to_review.text"),
                      ...
                      overflow: TextOverflow.ellipsis),
                  SizedBox(width: 4.0),
                  ImageIcon(AssetImage("assets/icons/leaveReview.png"),
                      color: Palette.primary, size: 16.0),
                ],
              )),
      ],
    );
