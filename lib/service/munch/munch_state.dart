...
class MunchState extends SuperState {
  ...
  MunchState.failed({exception, message = ""})
...
class MunchesFetchingState extends MunchState {
  ...
  MunchesFetchingState.loading({message = ""})
      : super.loading(message: message);

  MunchesFetchingState.failed({exception, message = ""})
      : super.failed(exception: exception, message: message);
}
...
class HistoricalMunchesPageFetchingState extends MunchState {
  ...
  HistoricalMunchesPageFetchingState.loading({message = ""})
      : super.loading(message: message);
...
class MunchJoiningState extends MunchState {
  ...
  MunchJoiningState.failed({exception, message = ""})
      : super.failed(exception: exception, message: message);
}
...
class MunchCreatingState extends MunchState {
  ...
  MunchCreatingState.failed({exception, message = ""})
      : super.failed(exception: exception, message: message);
}
...
class DetailedMunchFetchingState extends MunchState {
  ...
  DetailedMunchFetchingState.loading({message = ""})
      : super.loading(message: message);

  DetailedMunchFetchingState.failed({exception, message = ""})
      : super.failed(exception: exception, message: message);
}
...
class RestaurantsPageFetchingState extends MunchState {
  ...
  RestaurantsPageFetchingState.loading({message = ""})
      : super.loading(message: message);

  RestaurantsPageFetchingState.failed({exception, message = ""})
      : super.failed(exception: exception, message: message);
}
...
class RestaurantSwipeProcessingState extends MunchState {
  ...
  RestaurantSwipeProcessingState.loading({message = ""})
      : super.loading(message: message);
...
class NoMoreCarouselImageState extends MunchState {
  ...
  NoMoreCarouselImageState.loading({message = ""})
      : super.loading(message: message);

  NoMoreCarouselImageState.failed({exception, message = ""})
      : super.failed(exception: exception, message: message);
}
...
class MunchPreferencesSavingState extends MunchState {
  ...
  MunchPreferencesSavingState.loading({message = ""})
      : super.loading(message: message);

  MunchPreferencesSavingState.failed({exception, message = ""})
      : super.failed(exception: exception, message: message);
}
...
class KickingMemberState extends MunchState {
  ...
  KickingMemberState.failed({exception, message = ""})
      : super.failed(exception: exception, message: message);
}
...
class MunchLeavingState extends MunchState {
  ...
  MunchLeavingState.failed({exception, message = ""})
      : super.failed(exception: exception, message: message);
}
...
class CancellingMunchDecisionState extends MunchState {
  ...
  CancellingMunchDecisionState.loading({message = ""})
      : super.loading(message: message);

  CancellingMunchDecisionState.failed({exception, message = ""})
      : super.failed(exception: exception, message: message);
}
...
class ReviewMunchState extends MunchState {
  ...
  ReviewMunchState.loading({this.munchReviewValue, message = ""})
      : super.loading(message: message);

  ReviewMunchState.failed({exception, message = ""})
      : super.failed(exception: exception, message: message);
}
