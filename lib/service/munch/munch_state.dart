...
class HistoricalMunchesPageFetchingState extends MunchState {
  ...
  HistoricalMunchesPageFetchingState.failed({exception, message = ""}):super.failed(exception: exception, message: message);
}
...
class RestaurantSwipeProcessingState extends MunchState{
  ...
  RestaurantSwipeProcessingState.failed({exception, message = ""}):super.failed(exception: exception, message: message);
}
