...
class DetailedMunchNotificationState extends NotificationsState {
  ...
  DetailedMunchNotificationState.loading({message = ""})
...
class CurrentUserKickedNotificationState extends NotificationsState {
  CurrentUserKickedNotificationState(
      {initial = true, loading = false, hasError = false, message = ""})
      : super(
            initial: initial,
            loading: loading,
  ...
  CurrentUserKickedNotificationState.loading({message = ""})
      : super.loading(message: message);
