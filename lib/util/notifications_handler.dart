...
class NotificationsHandler {
  static const ANDROID_NOTIFICATION_CHANNEL_DEFAULT_NAME =
      "MUNCH-NOTIFICATION-CHANNEL";
  ...
  NotificationsHandler._internal() {
    ...
    notificationsEventTypeMap = Map.of({
      NotificationEventType.DECISION_MADE:
          _generateDecisionMadeNotificationEvent,
      NotificationEventType.MATCH_CLEARED:
          _generateNewRestaurantNotificationEvent,
  ...
  NotificationsEvent _generateDecisionMadeNotificationEvent(Map messageData) {
    return DecisionMadeNotificationEvent(
        ...
        timestampUTC: Utility.convertUnixTimestampToUTC(
  ...
  NotificationsEvent _mapNotificationEventType(Map messageData) {
    NotificationEventType notificationEventType = NotificationEventType.values
        .firstWhere((type) =>
            type.toString().split(".").last == messageData['eventType']);
          ...
          onMessage: (Map<String, dynamic> message) {
            ...
            NotificationsEvent notificationsEvent = Platform.isAndroid
                ? _mapNotificationEventType(message[
                    'data']) // message structure is different for Android and iOS
                : _mapNotificationEventType(message);
          ...
          onResume: (Map<String, dynamic> message) {
            ...
            Platform.isAndroid
                ? _onNotificationTapped(message['data'][
                    'deeplink']) // message structure is different for Android and iOS
