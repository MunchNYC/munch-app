...
class NavigationHelper {
  static PageRouteBuilder _buildPageScreen(
      {Widget screen,
  ...
  static Future _navigateTo(BuildContext context,
    ...
    if (addToBackStack) {
      return navigatorState.push(_buildPageScreen(
          screen: screen,
          transitionDuration: transitionDuration,
      ...
      isLastRouteOnStack(context, rootNavigator: rootNavigator).then((value) {
        ...
        if (value == true) {
          ...
          NavigationHelper.navigateToHome(context,
              addToBackStack: true, slideTransitionBuilder: NavigationAnimationHelper.noAnimation);
        }
      });
    }
  }
  ...
  static Future navigateToLogin(BuildContext context,
    ...
    if (popAllRoutes) {
      return _popAllRoutesAndNavigateTo(context,
          screen: LoginScreen(fromSplashScreen: fromSplashScreen),
          rootNavigator: true,
          transitionDuration: transitionDuration,
  ...
  static Future navigateToMapScreen(BuildContext context,
    ...
    return _navigateTo(context,
        addToBackStack: addToBackStack,
        screen: MapScreen(munchName: munchName, editLocation: editLocation, munch: munch),
        rootNavigator: true,
        navigatorState: navigatorState);
  }
  ...
  static Future navigateToRestaurantSwipeScreen(BuildContext context,
      {Munch munch,
      bool shouldFetchDetailedMunch: false,
      bool addToBackStack: true,
      NavigatorState navigatorState,
      bool popAllRoutes = false,
      Function slideTransitionBuilder}) {
  ...
  static Future navigateToMunchOptionsScreen(BuildContext context, {Munch munch, bool addToBackStack: true}) {
    return _navigateTo(context,
        addToBackStack: addToBackStack, rootNavigator: true, screen: MunchOptionsScreen(munch: munch));
  }

  static Future navigateToFiltersScreen(BuildContext context, {Munch munch, bool addToBackStack: true}) {
    return _navigateTo(context,
        addToBackStack: addToBackStack, rootNavigator: true, screen: FiltersScreen(munch: munch));
  }

  static Future navigateToPersonalInformationScreen(BuildContext context, {User user, bool addToBackStack: true}) {
    return _navigateTo(context,
        addToBackStack: addToBackStack, rootNavigator: true, screen: PersonalInformationScreen(user: user));
  }

  static Future navigateToPrivacyPolicyScreen(BuildContext context, {bool addToBackStack: true}) {
    return _navigateTo(context, addToBackStack: addToBackStack, rootNavigator: true, screen: PrivacyPolicyScreen());
  }

  static Future navigateToTermsOfServiceScreen(BuildContext context, {bool addToBackStack: true}) {
    return _navigateTo(context, addToBackStack: addToBackStack, rootNavigator: true, screen: TermsOfServiceScreen());
  }
}

class NavigationAnimationHelper {
  static SlideTransition noAnimation(
  ...
  static SlideTransition rightToLeftAnimation(
      BuildContext context, Animation animation, Animation secondaryAnimation, Widget child) {
  ...
  static SlideTransition bottomToTopAnimation(
      BuildContext context, Animation animation, Animation secondaryAnimation, Widget child) {
