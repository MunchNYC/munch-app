...
class NavigationHelper {
    ...
    if (addToBackStack) {
      ...
      return navigatorState.pushReplacement(
          _buildPageScreen(
              ...
              transitionDuration: transitionDuration,
              slideTransitionBuilder: slideTransitionBuilder ??
                  NavigationAnimationHelper.bottomToTopAnimation),
          result: result);
    }
  }
  ...
  static void popRoute(BuildContext context,
      {bool rootNavigator: true, var result, bool checkLastRoute: false}) {
    if (!checkLastRoute) {
  ...
  static void popUntilLastRoute(BuildContext context,
      {bool rootNavigator: true}) {
    Navigator.of(context, rootNavigator: rootNavigator)
        .popUntil((route) => route.isFirst);
  }

  static Future isLastRouteOnStack(BuildContext context,
      {bool rootNavigator: true}) {
  ...
  static Future navigateToMapScreen(BuildContext context,
    ...
    return _navigateTo(context,
        addToBackStack: addToBackStack,
        screen: MapScreen(
            munchName: munchName, editLocation: editLocation, munch: munch),
        rootNavigator: true,
        navigatorState: navigatorState);
  }
    ...
    if (popAllRoutes) {
      return _popAllRoutesAndNavigateTo(context,
          ...
          screen: RestaurantSwipeScreen(
              munch: munch, shouldFetchDetailedMunch: shouldFetchDetailedMunch),
          navigatorState: navigatorState,
          slideTransitionBuilder: slideTransitionBuilder);
    } else {
      return _navigateTo(context,
...
class NavigationAnimationHelper {
  static SlideTransition noAnimation(BuildContext context, Animation animation,
  ...
  static SlideTransition rightToLeftAnimation(BuildContext context,
  ...
  static SlideTransition bottomToTopAnimation(BuildContext context,
      Animation animation, Animation secondaryAnimation, Widget child) {
